...
public:
  ...
  /** Get the child node */
  TreeNode< TValueType > * GetChild(IdentifierType number) const;
  ...
  IdentifierType ChildPosition(const TreeNode< TValueType > *node) const;

  /** Return the child position given a value */
  IdentifierType ChildPosition(TValueType node) const;

  /** Add a child to the node */
  void AddChild(TreeNode< TValueType > *node);

  /** Add a child to the node and specify the number in the children list */
  virtual void AddChild(IdentifierType number, TreeNode< TValueType > *node);
